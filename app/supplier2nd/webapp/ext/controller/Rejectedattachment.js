    ...
    function (MessageBox, MessageToast, UIComponent) {
        ...
        function _createUploadController(oExtensionAPI, Entity) {
            ...
            return {
                ...
                onOk: function (oEvent) {
                //  debugger;
                    let inputString = oEvent.oSource.oPropagatedProperties.oModels.pageInternal.mContexts["/pages/supplier2nd::Invoice2_Invoice2ObjectPage/controls/fe::FormContainer::DATA"].oModel.oData.currentCtxt.sPath;
